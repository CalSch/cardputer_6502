...
struct amd {int amode; char desc[13];};
struct amd amdesc[] = {
  {ACMLT, "Accumulator"},
  {IMMDT, "Immediate"}, 
  {ZPAGE, "Zero Page"}, 
...
extern std::string in_text;
extern int input_head; // for pretending that in_text is a stream
extern std::string out_text;
extern std::string list_text;
